...
//		driver = new ChromeDriver();	
		...
		driver.get("https://www.spicejet.com/");          //a[@id='highlight-addons']
				
		Actions actmofo = new Actions(driver); 
		
		//Q: How do you simulate mouse movement or mouse hover?
		...
		actmofo.moveToElement(driver.findElement(By.xpath("//a[@id='highlight-addons']"))).build().perform(); //Customized xpath	
		
		//actmofo.moveToElement(driver.findElement(By.linkText("Add-Ons"))).build().perform(); //This link text we didn't get it to work so customize xpath above
